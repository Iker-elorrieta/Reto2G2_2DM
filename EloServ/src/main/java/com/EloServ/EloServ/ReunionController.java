...
public class ReunionController {
    ...
    public Map<String, Object> createReunion(@RequestBody Map<String, Object> body) {
        ...
        Users profesor = session.get(Users.class, (int) body.get("profesor_id"));
        Users alumno = session.get(Users.class, (int) body.get("alumno_id"));
    ...
    public String updateReunion(@PathVariable int id, @RequestBody Map<String, Object> body) {
        ...
        Reuniones r = session.get(Reuniones.class, id);
        if (r == null) {
            session.close();

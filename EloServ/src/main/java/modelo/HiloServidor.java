...
public class HiloServidor extends Thread {
	...
	private void verHorario(DataInputStream dis, ObjectOutputStream oos) { //
		try {
	...
	private void enviarListaProfesores(DataInputStream dis, ObjectOutputStream oos)
	        throws IOException {
	...
	private void enviarHorarioProfesor(DataInputStream dis, ObjectOutputStream oos)
	        throws IOException {
